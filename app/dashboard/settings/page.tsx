...
export default function SettingsPage() {
  ...
  const updateCurrency = useMutation(api.mutations.updateUserCurrency);
  ...
  useEffect(() => {
    if (userPreferences?.currency) {
      setSelectedCurrency(userPreferences.currency);
    }
  }, [userPreferences]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="border border-gray-200 rounded p-6">
            <h2 className="font-semibold text-lg mb-4">Currency</h2>
          ...
          <div>
            <h2 className="font-semibold text-lg mb-4">Platform Connections</h2>
